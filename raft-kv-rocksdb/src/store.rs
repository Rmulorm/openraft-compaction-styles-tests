...
impl ExampleStore {
    pub(crate) async fn new<P: AsRef<Path>>(db_path: P, compaction_style: u64) -> Arc<ExampleStore> {
        let mut db_opts = Options::default();
        db_opts.create_missing_column_families(true);
        db_opts.create_if_missing(true);
        db_opts.set_compaction_style(ExampleStore::get_compaction_style(compaction_style));
    ...
    fn get_compaction_style(compaction_style: u64) -> DBCompactionStyle {
        match compaction_style {
            1 => DBCompactionStyle::Fifo,
            2 => DBCompactionStyle::Level,
            3 => DBCompactionStyle::Universal,
